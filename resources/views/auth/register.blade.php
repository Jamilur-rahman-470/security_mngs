                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="type" id="password" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="gender" id="password" class="form-control">
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">DBO</label>

                                <div class="col-md-6">

                                    <input type="text" name='DBO' required class="form-control">
                                </div>
                            </div>
